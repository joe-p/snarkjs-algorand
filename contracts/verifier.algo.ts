...
function verifyFromTemplate(signals: PublicSignals, proof: Proof): boolean {
...
function getChallenge(td: bytes): Uint256 {
...
function calculateLagrangeEvaluations(
...
function calculatePI(publicSignals: PublicSignals, L: Uint256[]): Uint256 {
  let pi = BigUint(0);
