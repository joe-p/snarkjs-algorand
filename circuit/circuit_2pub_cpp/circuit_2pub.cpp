...
// load src
Fr_mul(&expaux[1],&signalValues[mySignalStart + 2],&signalValues[mySignalStart + 2]); // line circom 10
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 1]); // line circom 10
// end load src
...
Fr_add(&expaux[0],&expaux[1],&signalValues[mySignalStart + 1]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
